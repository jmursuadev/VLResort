...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="margin-top: 20px; margin-bottom: 20px;">
                <div class="panel panel-default" style="border-color: maroon;">
                    <div class="panel-heading" style="color: #fff;background-color: maroon;border-color: maroon;">Login</div>
