...
@section('content')
    ...
    <div class="container">
        ...
        @forelse($rooms as $room)
            <div class="row">
                <div class="col-md-7">
                    <div class="form-group">
                        <div class="room-item" >
                            <img src="{{ asset('storage/upload/'.$room->url) }}" alt="{{ $room->room_name }}" style="width: 100%; border-radius: 20px; border: 1px solid maroon;">
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="room-description">
                        <h4 style="font-weight: bold; color: maroon;text-transform: uppercase; font-size: 25px; margin-bottom: 20px;">{{ $room->room_name }}</h4>
                        <strong style="font-size: 16px;">{{ $room->description }}</strong>
                        <ul class="about-list">
                            <li class="">
                                <span class="fa fa-dot-circle-o"></span>
                                <strong>Pax/Room - </strong><em>{{ $room->GuestMax }} Pax</em>
                            </li>
                            <li class="">
                                <span class="fa fa-dot-circle-o"></span>
                                <strong>Price - </strong><em>{{ $room->price }}</em>
                            </li>
                        </ul>
            ...
            <hr>
            @empty
                <h1 class="text-center">NO ROOMS FOR A WHILE!</h1>
        @endforelse
    </div>
@endsection