...
@section('content')
    ...
    <div class="container">
        ...
        @forelse($cottages as $cottage)
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        <div class="cottage-item" >
                            <img src="{{ asset('storage/upload/'.$cottage->url) }}" alt="{{ $cottage->cottage_name }}" style="width: 100%; border-radius: 20px; border: 1px solid maroon;">
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="cottage-description">
                        <h4 style="font-weight: bold; color: maroon;text-transform: uppercase; font-size: 25px; margin-bottom: 20px;">{{ $cottage->cottage_name }}</h4>
                        <strong style="font-size: 16px;">{{ $cottage->description }}</strong>
                        <ul class="about-list">
                            <li class="">
                                <span class="fa fa-dot-circle-o"></span>
                                <strong>Pax/Cottage - </strong><em>{{ $cottage->GuestMax }} Pax</em>
                            </li>
                            <li class="">
                                <span class="fa fa-dot-circle-o"></span>
                                <strong>Price - </strong><em>{{ $cottage->price }}</em>
                            </li>
                        </ul>
            ...
            <hr>
            @empty
                <h1 class="text-center">NO COTTAGES FOR A WHILE!</h1>
        @endforelse
    </div>
@endsection